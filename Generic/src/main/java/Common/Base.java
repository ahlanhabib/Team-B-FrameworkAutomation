...
public class Base {
    ...
    public void setUp(@Optional("false") boolean useCloudEnv,
                      @Optional("Nahreen") String userName,
...
//            logger.info("Test is running on Local");
    ...
    public WebDriver getLocalDriver(String browserName) {
        if (browserName.equalsIgnoreCase("chrome")) {
            ...
            System.setProperty("webdriver.gecko.driver", "C:\\Users\\AFMErshadul\\IdeaProjects\\AutomationHWork\\Generic\\supporting_exe\\geckodriver.exe");
            driver = new FirefoxDriver();
        } else if (browserName.equalsIgnoreCase("ie")) {
            System.setProperty("webdriver.ie.driver", "C:\\Users\\AFMErshadul\\IdeaProjects\\AutomationHWork\\Generic\\supporting_exe\\IEDriverServer.exe");
